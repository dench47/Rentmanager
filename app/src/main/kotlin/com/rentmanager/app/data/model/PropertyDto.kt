...
data class PropertyDto(
    ...
    @SerializedName("rent_type") val rentType: String? = null,
    @SerializedName("rooms") val rooms: String? = null,
    @SerializedName("sleeping_places") val sleepingPlaces: String? = null,
    @SerializedName("floor") val floor: String? = null,
    @SerializedName("floors_in_house") val floorsInHouse: String? = null,
